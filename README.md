...
Wenxin Fu, Zhengkun Tian, Ye Bai, Yingming Gao, Ya Li
...
Each video shows a paired interaction result. The left side is the interaction partner; the right side is the generated avatar response. For multi-model comparisons, see the [project page](https://wx-fu.github.io/HERM/).
...
The corresponding source MP4 files are also available in [the demo folder](docs/assets/readme-demos/).
